-- ============================================================================
-- ZAI FLOW 2.0 - HR & Payroll RPC Functions (CLEAN - NO SCHEMA)
-- Run ONLY this file after supabase-schema-hr.sql
-- ============================================================================
...
BEGIN
  ...
  WHERE pr.month = p_month AND pr.year = p_year AND pr.status != 'REVERSED'
  LIMIT 1;
